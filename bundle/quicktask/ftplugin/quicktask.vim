...
" ============================================================================
" Key mappings {{{1
nmap <buffer> <space>v :call <SID>SelectTask()<CR>
nmap <buffer> <space>D :call <SID>TaskComplete()<CR>
nmap <buffer> <space>a :call <SID>ShowActiveTasksOnly()<CR>
nmap <buffer> <space>w :call <SID>ShowWatchedTasksOnly()<CR>
nmap <buffer> <space>y :call <SID>ShowTodayTasksOnly()<CR>
nmap <buffer> <space>s :call <SID>AddNextTimeToTask()<CR>
nmap <buffer> <space>O :call <SID>AddTaskAbove()<CR>
nmap <buffer> <space>o :call <SID>AddTaskBelow()<CR>
nmap <buffer> <space>c :call <SID>AddChildTask()<CR>
nmap <buffer> <space>u :call <SID>MoveTaskUp()<CR>
nmap <buffer> <space>d :call <SID>MoveTaskDown()<CR>
nmap <buffer> <space>S :call <SID>AddSnipToTask()<CR>
nmap <buffer> <space>j :call <SID>JumpToSnip()<CR>
nmap <buffer> <space>f :call <SID>FindIncompleteTimestamps()<CR>:silent set hlsearch \| echo<CR>
